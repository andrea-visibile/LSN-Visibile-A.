...
//update of the histogram of g(r) //INSERT CODE HERE
...
// contribution to energy and virial
  ...
  ofstream out, out2;
  out.open("pot_ist.dat",ios::app);
  out2.open("press_ist.dat",ios::app);
  out << walker[iv]/(double)npart + vtail<<endl;
  out2 << rho * temp + (walker[iw] + ptail * (double)npart) / vol<<endl;
  out.close();
  out2.close();
